  ...
  async (context) => {
    ...
    if (contentType.includes("text/html")) {
      newResponse.headers.set(
        ...
        "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://img.shields.io; font-src 'self'; connect-src 'self' https://api.github.com https://*.svartsecurity.org; frame-ancestors 'none'; form-action 'self' https://www.paypal.com; upgrade-insecure-requests"
      );
    }
